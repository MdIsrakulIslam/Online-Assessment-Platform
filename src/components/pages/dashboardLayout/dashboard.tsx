        ...
        <div className="w-full max-w-7xl mx-auto py-8 px-8 flex flex-col min-h-full pb-16">
            <div className="flex items-center justify-between mb-8">
                ...
                <div className="flex items-center gap-4">
                    <div className="relative shadow-sm rounded-md">
                        ...
                        />
                        <div className="absolute right-3 top-1/2 -translate-y-1/2 w-6 h-6 flex items-center justify-center bg-[#8376ff]/10 rounded">
            ...
            {exams.length === 0 ? (
                <div className="flex flex-col items-center justify-center flex-1 py-40 bg-white rounded-2xl shadow-sm border border-gray-100 mt-4">
                    ...
                    <h2 className="text-xl font-bold text-gray-900 mb-2">No Online Test Available</h2>
                    <p className="text-gray-500 text-center max-w-md text-sm">
                        Presently, there are no online tests available. Please check back later for updates.
                    </p>
                </div>
            ) : (
                <div className="mt-4 flex flex-col items-center flex-1 w-full justify-between">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 w-full">
                        {paginatedExams.map((exam: any) => (
                            <div key={exam.id} className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm flex flex-col gap-6">
                                <h3 className="font-bold text-lg text-gray-800 tracking-tight">{exam.title}</h3>
                    ...
                    <div className="w-full mt-auto pt-8 flex items-center justify-between">
